...
public class ConexionSQLite extends SQLiteOpenHelper {
    ...
    String TABLE_NOTI = "CREATE TABLE NOTI(id_noti int PRIMARY KEY not null, fecha DATE,horario TIme,id_tarea int, Constraint fk_id_tarea FOREIGN KEY (id_tarea) references TAREA(id_tarea));";
